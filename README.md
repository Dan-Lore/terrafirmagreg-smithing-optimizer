...
**Версия 2.1.0** (в `package.json`). На GitHub до push остаётся последний закоммиченный снимок **0.1.0** под именем `g-point-steps-spa`; подробное сравнение — в [`CHANGELOG.md`](CHANGELOG.md).
